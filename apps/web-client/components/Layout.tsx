                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        <Link href="/" className="flex items-center gap-2 cursor-pointer flex-shrink-0">
                            ...
                            <span className="text-xl md:text-2xl font-bold font-heading text-slate-900 tracking-tight">Creative<span className="text-accent">OS</span></span>
                        </Link>

                        <nav className="hidden xl:flex space-x-6 overflow-visible flex-1 justify-center px-4 relative z-50">
                            <Link
                                href="/"
                                className={`text-[13px] font-bold tracking-wide transition-colors whitespace-nowrap px-2 py-1 rounded-md hover:bg-slate-50 hover:text-accent ${isActive('/') ? 'text-accent bg-blue-50/50' : 'text-slate-500'}`}
                            >
                                Home
                            </Link>
                                ...
                                <>
                                    {mainNavItems.map((item) => (
                                        <Link
                                            key={item.id}
                                            href={item.href}
                                            className={`text-[13px] font-bold tracking-wide transition-colors whitespace-nowrap px-2 py-1 rounded-md hover:bg-slate-50 hover:text-accent ${isActive(item.href) ? 'text-accent bg-blue-50/50' : 'text-slate-500'}`}
                                        >
                                            {item.label}
                                        </Link>
                                    ))}
                                    ...
                                    >
                                        <button className={`text-[13px] font-bold tracking-wide transition-colors whitespace-nowrap px-2 py-1 rounded-md hover:bg-slate-50 hover:text-accent flex items-center gap-1 ${featuresOpen ? 'text-accent bg-blue-50/50' : 'text-slate-500'}`}>
