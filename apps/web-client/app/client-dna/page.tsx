    ...
    return (
        <div className="flex gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in slide-in-from-bottom-4 duration-500 w-full">
            <div className="flex-1 space-y-8">
                <div>
                    <h1 className="text-3xl font-bold font-heading text-slate-900 dark:text-white">Client DNA Profile</h1>
                ...
                {sections.map((section, idx) => (
                    <div key={idx} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm">
                        ...
                        <div className="p-6 space-y-5">
                            <div className="bg-slate-50 dark:bg-slate-950 border border-indigo-100 rounded-lg p-3 flex items-center gap-2 text-sm text-indigo-600">
                            ...
                            {section.title === 'Brand Identity' && (
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" placeholder="e.g. Squadra Media" className="w-full px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" placeholder="Your memorable tagline" className="w-full px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                                    ...
                                    <div>
                                        ...
                                        <textarea placeholder="Share your brand's origin, mission, and what makes it unique..." className="w-full h-32 px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none resize-none"
                            ...
                            {section.title === 'Industry & Audience' && (
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <select className="w-full px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                                    ...
                                    <div>
                                        ...
                                        <textarea placeholder="e.g. Marketing managers at B2B SaaS companies, aged 28–45..." className="w-full h-24 px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none resize-none"
                            ...
                            {section.title === 'Brand Tone' && (
                                <div className="space-y-4">
                                            ...
                                            {BRAND_TONES.map(tone => (
                                                <button key={tone} type="button"
                                                    ...
                                                    className={`p-3 rounded-xl border-2 text-sm font-bold transition-all ${formData.brandTone === tone
                                                        ...
                                                        : 'border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:border-pink-300'}`}>
                                                    {tone}
                                                </button>
                                            ))}
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea placeholder="Describe any specific tone nuances, words to avoid, or style preferences..." className="w-full h-24 px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none resize-none"
                                            ...
                                            {GOALS.map(g => (
                                                <button key={g} type="button"
                                                    ...
                                                    className={`p-3 rounded-xl border-2 text-xs font-bold transition-all ${formData.selectedGoals.includes(g)
                                                        ...
                                                        : 'border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:border-green-300'}`}>
                                                    {g}
                                                </button>
                                            ))}
                                        </div>
                            ...
                            {section.title === 'Geography & Notes' && (
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" placeholder="e.g. UAE, Saudi Arabia, India, UK..." className="w-full px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" placeholder="e.g. English, Arabic, Hindi..." className="w-full px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                                    ...
                                    <div>
                                        ...
                                        <textarea placeholder="Anything else AI should know — competitors, sensitive topics to avoid, key differentiators..." className="w-full h-32 px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none resize-none"
                ...
                <div className="sticky top-24 space-y-6">
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="font-bold text-slate-900 dark:text-white">DNA Preview</h3>
                            <span className="text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 px-2 py-0.5 rounded uppercase font-bold">Live</span>
                        </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="font-bold text-slate-900 dark:text-white">Where DNA Flows</h3>
                        </div>
                        <div className="space-y-4">
                            {[
