  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm p-8 space-y-8">
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Daily Operations</h2>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">Performance Over Time</h3>
            <div className="h-48 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-100 dark:border-slate-800 flex items-center justify-center italic text-slate-400">
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="p-4 border border-slate-50 rounded-xl bg-slate-50 dark:bg-slate-950/50 space-y-1">
                  ...
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">{insight.text}</p>
                </div>
              ))}
            </div>
          ...
          <div className="bg-accent rounded-3xl p-8 text-white space-y-4 relative overflow-hidden shadow-xl shadow-blue-200">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white dark:bg-slate-900/10 rounded-full -mr-16 -mt-16 blur-2xl"></div>
            ...
            <button className="bg-white dark:bg-slate-900 text-accent px-4 py-2 rounded-lg font-bold text-xs">Upgrade Now</button>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center px-4">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">Active Campaign Status</h2>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
          <table className="w-full text-left text-sm">
            <thead className="bg-slate-50 dark:bg-slate-950 border-b border-slate-100 dark:border-slate-800 text-slate-400 text-[10px] font-bold uppercase tracking-widest">
              <tr>
            ...
            <tbody className="divide-y divide-slate-50 text-slate-600 dark:text-slate-400 font-medium">
              {[
                ...
                <tr key={i} className="hover:bg-slate-50 dark:bg-slate-950 transition-colors cursor-pointer group">
                  <td className="px-8 py-6">
                    <p className="font-bold text-slate-900 dark:text-white group-hover:text-accent transition-colors">{c.name}</p>
                    <p className="text-xs text-slate-400">ID: CAM-00{i + 1}</p>
                  </td>
                  <td className="px-8 py-6">
                    <span className={`px-2 py-1 rounded-full text-[10px] font-bold uppercase ${c.status === 'Running' ? 'bg-green-50 text-green-600' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'}`}>{c.status}</span>
                  </td>
